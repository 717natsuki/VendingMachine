...
struct ContentView: View {
    ...
    fileprivate func extractedFunc(color: Color, nameDrink: String, index: Int, type: Int) -> some View {
        return VStack {
            if (type == 0){
                drinkCan(drinkColor: color)
    ...
    fileprivate func eachDrinkWhenBought(num: Int, drinkName: String, color: Color) -> some View {
        return String(self.drinkBought2[num]) == drinkName ?
            ...
            :
            drinkPlastic(capColor: color, drinkColor: color, type: 1)
        ...
        return VStack {
            VStack {
                ...
                VStack(alignment: .center, spacing: 10) {
                    ...
                    HStack(spacing: 24) {
                        extractedFunc(color: Color.black, nameDrink: "Cola", index: 0, type: 1)
                        extractedFunc(color: Color.black, nameDrink: "Cola", index: 1, type: 1)
                        extractedFunc(color: Color.green, nameDrink: "Tea", index: 2, type: 1)

                        extractedFunc(color: Color.orange, nameDrink: "Orange", index: 3, type: 1)
                        extractedFunc(color: Color.white, nameDrink: "Water", index: 4, type: 1)

                    }
                        .padding([.top, .leading, .trailing], 4.0)
                    Divider()
                    HStack(spacing: 24) {
                        extractedFunc(color: Color.blue, nameDrink: "Energy", index: 5, type: 1)
                        extractedFunc(color: Color(red: 248 / 255, green: 102 / 255, blue: 70 / 255)
                            , nameDrink: "Fanta", index: 6, type: 1)
                        extractedFunc(color: Color.yellow, nameDrink: "Apple", index: 7, type: 1)
                        extractedFunc(color: Color.orange, nameDrink: "Orange", index: 8, type: 1)
                        extractedFunc(color: Color.white, nameDrink: "Water", index: 9, type: 1)
                    }
                        .padding([.leading, .bottom, .trailing], 4.0)
                }
                    .frame(height: 240.0)
                                ...
                                if 1 > 0 {
                                    VStack {
                                        ...
                                        ZStack {
                                            ...
                                            self.eachDrinkWhenBought(num: num, drinkName: "Fanta", color: Color.orange)
                                            self.eachDrinkWhenBought(num: num, drinkName: "Pepsi", color: Color.yellow)
                                            self.eachDrinkWhenBought(num: num, drinkName: "Orange", color: Color.orange)
                                            self.eachDrinkWhenBought(num: num, drinkName: "Water", color: Color.white)
                                            self.eachDrinkWhenBought(num: num, drinkName: "Energy", color: Color.blue)
                                            self.eachDrinkWhenBought(num: num, drinkName: "Apple", color: Color.yellow)
